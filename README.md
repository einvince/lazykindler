...
- 🌈 支持书籍导入，并以高效的方式展示书籍列表
- 💅 支持创建书籍合集，比如科幻小说集合、武侠小说集合
- 🚀 多维度书籍信息展示，可以从书名、作者、评分、集合、标签等多维度展示
- 🛡 搜索，可以从书名、作者、出版社等任何一个关键词搜索相关书籍
- 📦 下载，可以下载书籍，也可以下载平台管理的所有书籍
- 🛡 书籍阅读，平台支持书籍阅读功能
- 📦 备份功能，平台数据库采用了sqlite3，并且所有书籍都放在了指定目录，十分适合备份
- 🎻 高亮笔记，电脑连接kindle后，平台可以自动导入高亮笔记
- 📣 高亮笔记，安卓平台支持导入 静读天下apk 导出的笔记文件
- 🎺 高亮笔记，支持对导入平台的高亮笔记做二次高亮、二次高亮删除
- 🥁 高亮笔记，平台支持对高亮笔记添加评论
...
### 安卓平台导入 静读天下apk 软件的高亮文件
对于使用安卓平台阅读电子书的情况，目前支持导入 静读天下apk 软件导出的高亮笔记，这个软件是我目前发现的最好用的安卓平台阅读器，它可以在阅读电子书时对文字做高亮操作，最后可以在软件中导出这些笔记为 `.mrexpt` 格式的高亮笔记文件。把这个文件放到`~/Download`、`~/下载`、`~/Desktop`、`~/桌面`任何一个目录下，平台可以自动完成导入操作。
