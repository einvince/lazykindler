...
- 🌈 书籍导入，并以高效的方式展示书籍列表。
- 💝 使用Chatgpt搜索书籍的介绍信息。(目前免费版的chatgpt服务响应较慢, 需要等待数秒钟才能给出数据)
- 😻 使用Chatgpt搜索作者的介绍信息。(目前免费版的chatgpt服务响应较慢, 需要等待数秒钟才能给出数据)
...
## 2. 集成了 `chatgpt` 功能
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在书籍的`操作`里有两个选项 `查询作者信息` 和 `查询书籍信息`。这两个功能在后端调用了 `chatgpt` 的接口来给出数据。目前免费版的chatgpt服务响应较慢, 需要等待数秒钟才能给出数据。
